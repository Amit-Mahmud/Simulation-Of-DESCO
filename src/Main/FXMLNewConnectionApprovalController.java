 ...
 * @author Mahmud Amit
 */
public class FXMLNewConnectionApprovalController implements Initializable {

    @FXML
    private ComboBox actionComboField;
    @FXML
    private Label label;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        actionComboField.getItems().addAll("Approve", "Decline");
    }
    ...
    @FXML
    private void onClickBackToHomepage14(ActionEvent event) throws IOException {
