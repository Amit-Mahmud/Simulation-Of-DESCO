 ...
 * @author Mahmud Amit
 */
public class FXMLCheckNetworkStatisticsController implements Initializable {
    ...
    @FXML
    private void onClickBackToHomepageButton11(ActionEvent event) throws IOException {
