 ...
 * @author Mahmud Amit
 */
public class FXMLAdministrationLogInController implements Initializable {

    User c = null;
    @FXML
    private ComboBox communicateCombo;

    public void initData3(User cus) {
        c = cus;
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        communicateCombo.getItems().addAll("Manager", "IT Admin");
    }

    @FXML
    private void onClickPostAnnouncementButton(ActionEvent event) throws IOException {
    ...
    @FXML
    private void onClickLogOutButton4(ActionEvent event) throws IOException {
        FXMLLoader loader1 = new FXMLLoader();
    ...
    @FXML
    private void onClickShowAllStuffInformation(ActionEvent event) throws IOException {
        FXMLLoader loader1 = new FXMLLoader();
